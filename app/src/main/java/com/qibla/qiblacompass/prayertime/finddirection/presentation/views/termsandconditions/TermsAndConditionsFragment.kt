package com.qibla.qiblacompass.prayertime.finddirection.presentation.views.termsandconditions
...
import com.qibla.qiblacompass.prayertime.finddirection.databinding.FragmentTermsAndConditionsBinding
...
class TermsAndConditionsFragment :
    BaseFragment<FragmentTermsAndConditionsBinding>(R.layout.fragment_terms_and_conditions) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbarTermsConditions.groupToolbarSubScreenProfile.visibility = View.VISIBLE
        binding.toolbarTermsConditions.tvToolbarSubScreen.text = getString(R.string.privacy)
        webView = binding.webViewTermsConditions

        binding.toolbarTermsConditions.viewSubScreen.setOnClickListener {
